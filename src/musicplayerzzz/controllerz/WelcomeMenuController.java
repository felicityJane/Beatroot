...
import musicplayerzzz.Server_Connector;
import musicplayerzzz.TemporaryAlbumClass;
...
public class WelcomeMenuController implements Initializable {
    ...
    private static String logInMenuPath = "viewz/logInMenu.fxml";
    private URL url;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image img = new Image("imagezzzz/PlayNormal.jpg");
       btnPlay.setFill(new ImagePattern(img));
        Image img1 = new Image("imagezzzz/StopNormal.jpg");
        btnStop.setFill(new ImagePattern(img1));
        Image img2 = new Image("imagezzzz/PauseNormal.jpg");
        btnPause.setFill(new ImagePattern(img2));
        tglLoop.setText("⟳");
        /*String css = this.getClass().getResource("/musicPlayer/cssz/welcomePage.css").toExternalForm();
        ...
        tempAlbum.setAlbumCover(new Image("imagezzzz/Celldweller_EoaE_BG_LOVE.jpg"));
        ...
        tempAlbum2.setAlbumCover(new Image("imagezzzz/Linkin Park - Living Things.jpg"));
        Path path = Paths.get(tempAlbum.getTracks().get(0));
        lstMainTracks.getItems().addAll(tempAlbum.getTracks());
        imgVolume.setImage(new Image("imagezzzz/VolumeHigh.png"));

        imgMain.setImage(tempAlbum.getAlbumCover());
        imgNews1.setImage(new Image("imagezzzz/Linkin Park - Living Things.jpg"));
        imgNews2.setImage(new Image("imagezzzz/Konachan.jpg"));
        imgNews3.setImage(new Image("imagezzzz/EyeGirl.jpg"));
        imgNews4.setImage(new Image("imagezzzz/Hadean.jpg"));
        imgNews5.setImage(new Image("imagezzzz/Celldweller_EoaE_BG_LOVE.jpg"));
        imgNews6.setImage(new Image("imagezzzz/Rage Against the Machine - Rage Against the Machine.jpg"));
        imgMain.setImage(tempAlbum.getAlbumCover());
    ...
    protected void onLogOutButtonPressed(ActionEvent event){
        ...
        if (answer){
            try {
                ...
                SceneManager.sceneManager.changeScene(event,"viewz/logInMenu.fxml");
    ...
    private void hoverOnPlayButton() {
        Image img = new Image("imagezzzz/PlayHover.jpg");
        btnPlay.setFill(new ImagePattern(img));
    }

    @FXML
    private void hoverOnPauseButton() {
        Image img = new Image("imagezzzz/PauseHover.jpg");
        btnPause.setFill(new ImagePattern(img));
    }

    @FXML
    private void hoverOnStopButton() {
        Image img = new Image("imagezzzz/StopHover.jpg");
    ...
    private void leavePauseButton() {
        Image img = new Image("imagezzzz/PauseNormal.jpg");
        btnPause.setFill(new ImagePattern(img));
    }

    @FXML
    private void leaveStopButton() {
        Image img = new Image("imagezzzz/StopNormal.jpg");
        btnStop.setFill(new ImagePattern(img));
    }

    @FXML
    private void pressOnPlayButton() {
        Image img = new Image("imagezzzz/PlayPressed.jpg");
        btnPlay.setFill(new ImagePattern(img));
    }

    @FXML
    private void pressOnPauseButton() {
        Image img = new Image("imagezzzz/PausePressed.jpg");
        btnPause.setFill(new ImagePattern(img));
    }

    @FXML
    private void pressOnStopButton() {
        Image img = new Image("imagezzzz/StopPressed.jpg");
        btnStop.setFill(new ImagePattern(img));
    }
    ...
    private void runMediaPlayer(Path path) {
        ...
        sliderVolume.valueProperty().addListener(observable -> {
            ...
            if (sliderVolume.getValue() == 0.0) {
                imgVolume.setImage(new Image("imagezzzz/VolumeOff.png"));
            } else if (sliderVolume.getValue() > 0.0 && sliderVolume.getValue() < 40) {
                imgVolume.setImage(new Image("imagezzzz/VolumeLow.png"));
            } else if (sliderVolume.getValue() >= 40 && sliderVolume.getValue() < 85) {
                imgVolume.setImage(new Image("imagezzzz/VolumeMed.png"));
            } else {
                imgVolume.setImage(new Image("imagezzzz/VolumeHigh.png"));
            }
        });
