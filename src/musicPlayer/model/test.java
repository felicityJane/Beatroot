...
public class test {
	public static void main(String[] args) {
		...
		//
		// Administrator us = new Administrator("Viktor", "qwe", "Viktor",
		// "Nikolov", "viktors@f2f.cx",
		// "13 Gloucester Street South", "Oldham", "OL9 7RJ", "United Kingdom",
		// "Male", "0737181299",
		...
		// e.printStackTrace();
		// }
		// model.MusicTrack track = new model.MusicTrack("Asd", "sqseq",
		// Genre.CLASSICAL, Genre.BLUEGRASS,
		// Genre.DEATH_METAL);
		//
		// System.out.println(track.getGenre().length);
